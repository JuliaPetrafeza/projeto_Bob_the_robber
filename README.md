...
O cenário e os elementos do jogo , como o próprio Bob, o guarda e os tesouros , são renderizados utilizando caracteres ASCII. Os comandos de movimentação do personagem são mapeados para as teclas direcionais do teclado, oferecendo uma jogabilidade intuitiva e sem limite de tempo. O foco principal do sistema é aplicar conceitos de lógica de programação, matrizes para mapeamento do ambiente e tratamento de entradas de usuário em tempo real em um ambiente de linha de comando.
